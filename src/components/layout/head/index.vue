    ...
    <div class="head">
      <div class="left">
        ...
        <div class="nav">
          ...
          <a
            class="item"
            :class="{
              active: router.currentRoute.value.name === 'area',
            }"
            @click.prevent="router.push({ name: 'area' })"
          >
            {{ t('layout.area') }}
          </a>
          ...
          <Dropdown class="item">
            ...
            <template #list>
              <div class="list">
                <a
                  class="item"
                  @click.prevent="router.push({ name: 'downloadLive' })"
                >
                ...
                <a
                  class="item"
                  @click.prevent="
                    router.push({ name: 'downloadRemoteDesktop' })
                  "
                >
      ...
      <div class="right">
        ...
        <a
          ...
          :class="{
            active:
              router.currentRoute.value.name === 'privatizationDeployment',
          }"
          href="/privatizationDeployment"
          @click.prevent="router.push({ name: 'doc-privatizationDeployment' })"
        >
          {{ t('layout.deploy') }}
          <div class="badge">
...
import {
  isMobile as isMobileEnv,
  openToTarget as openToTargetEnv,
  windowReload,
} from 'billd-utils';
...
const about = ref([
  {
    label: 'layout.faq',
    routerName: 'about-faq',
    url: '',
  },
  {
    label: 'layout.team',
    routerName: 'about-team',
    url: '',
  },
  {
    label: 'layout.author',
    routerName: 'about-author',
    url: '',
  },
  {
    label: 'layout.officialGroup',
    routerName: 'about-group',
    url: '',
  },
  {
    label: 'layout.sponsor',
    routerName: 'about-sponsors',
    url: '',
  },
  {
    label: 'layout.release',
    routerName: 'about-release',
    url: '',
  },
]);
